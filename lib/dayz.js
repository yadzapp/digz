...
class Valve extends Core {
  ...
  async cleanup(/** Results */ state) {
    ...
    delete state.bots;
    delete state.raw.numbots
    delete state.raw.game
    delete state.raw.appId
    delete state.raw.protocol
    delete state.raw.folder
    delete state.raw.listentype
    delete state.raw.environment
    delete state.raw.secure
    delete state.raw.steamid
    delete state.raw.rules
    
    state.raw.version = state.version
    delete state.raw.version
    state.raw.numplayers = state.numplayers
    delete state.raw.numplayers
